...
export const SUGGESTED_BOOKS = [
  // Toddlers (0-3)
  { id: 'goodnight-moon', title: 'Goodnight Moon', author: 'Margaret Wise Brown', illustrator: 'Clement Hurd', ageGroup: 'toddler', genre: 'Bedtime', description: 'A classic bedtime story with soothing rhymes.' },
  ...
  { id: 'brown-bear', title: 'Brown Bear, Brown Bear, What Do You See?', author: 'Bill Martin Jr.', illustrator: 'Eric Carle', ageGroup: 'toddler', genre: 'Learning', description: 'Colorful animals and repetitive text perfect for little ones.' },
  ...
  { id: 'guess-how-much', title: 'Guess How Much I Love You', author: 'Sam McBratney', illustrator: 'Anita Jeram', ageGroup: 'toddler', genre: 'Family', description: 'A heartwarming story about love between parent and child.' },
  ...
  { id: 'chicka-chicka', title: 'Chicka Chicka Boom Boom', author: 'Bill Martin Jr.', illustrator: 'Lois Ehlert', ageGroup: 'preschool', genre: 'Learning', description: 'A rhythmic alphabet adventure up the coconut tree.' },
  { id: 'gruffalo', title: 'The Gruffalo', author: 'Julia Donaldson', illustrator: 'Axel Scheffler', ageGroup: 'preschool', genre: 'Fantasy', description: 'A clever mouse outsmarts predators with an imaginary creature.' },
  ...
  { id: 'if-you-give-mouse', title: 'If You Give a Mouse a Cookie', author: 'Laura Numeroff', illustrator: 'Felicia Bond', ageGroup: 'preschool', genre: 'Humor', description: 'A circular tale of cause and effect.' },
  ...
  { id: 'amelia-bedelia', title: 'Amelia Bedelia', author: 'Peggy Parish', illustrator: 'Fritz Siebel', ageGroup: 'early-elementary', genre: 'Humor', description: 'A literal-minded housekeeper creates hilarious chaos.' },
  { id: 'magic-tree-house', title: 'Magic Tree House: Dinosaurs Before Dark', author: 'Mary Pope Osborne', illustrator: 'Sal Murdocca', ageGroup: 'early-elementary', genre: 'Adventure', description: 'Jack and Annie travel through time.' },
  { id: 'junie-b-jones', title: 'Junie B. Jones and the Stupid Smelly Bus', author: 'Barbara Park', illustrator: 'Denise Brunkus', ageGroup: 'early-elementary', genre: 'Humor', description: 'A spunky kindergartner navigates school.' },
  { id: 'mercy-watson', title: 'Mercy Watson to the Rescue', author: 'Kate DiCamillo', illustrator: 'Chris Van Dusen', ageGroup: 'early-elementary', genre: 'Humor', description: 'A toast-loving pig saves the day.' },
  ...
  { id: 'dragons-love-tacos', title: 'Dragons Love Tacos', author: 'Adam Rubin', illustrator: 'Daniel Salmieri', ageGroup: 'early-elementary', genre: 'Humor', description: 'Dragons really, really love tacos (but not salsa!).' },

  // Elementary (7-9)
  { id: 'charlottes-web', title: "Charlotte's Web", author: 'E.B. White', illustrator: 'Garth Williams', ageGroup: 'elementary', genre: 'Classic', description: 'A spider saves her pig friend through the power of words.' },
  { id: 'bfg', title: 'The BFG', author: 'Roald Dahl', illustrator: 'Quentin Blake', ageGroup: 'elementary', genre: 'Fantasy', description: 'A big friendly giant and a little girl capture dreams.' },
  { id: 'stuart-little', title: 'Stuart Little', author: 'E.B. White', illustrator: 'Garth Williams', ageGroup: 'elementary', genre: 'Adventure', description: 'A mouse born to a human family goes on adventures.' },
  ...
  { id: 'ramona', title: 'Ramona Quimby, Age 8', author: 'Beverly Cleary', illustrator: 'Alan Tiegreen', ageGroup: 'elementary', genre: 'Realistic', description: 'Third-grader Ramona faces everyday challenges.' },
  { id: 'james-peach', title: 'James and the Giant Peach', author: 'Roald Dahl', illustrator: 'Quentin Blake', ageGroup: 'elementary', genre: 'Fantasy', description: 'A boy escapes in a magical giant peach.' },
  { id: 'mr-popper', title: "Mr. Popper's Penguins", author: 'Richard Atwater', illustrator: 'Robert Lawson', ageGroup: 'elementary', genre: 'Humor', description: 'A house painter receives a penguin from Antarctica.' },
  { id: 'fantastic-mr-fox', title: 'Fantastic Mr. Fox', author: 'Roald Dahl', illustrator: 'Quentin Blake', ageGroup: 'elementary', genre: 'Adventure', description: 'A clever fox outwits three mean farmers.' },
  { id: 'cricket-times-square', title: 'The Cricket in Times Square', author: 'George Selden', illustrator: 'Garth Williams', ageGroup: 'elementary', genre: 'Fantasy', description: 'A musical cricket finds friendship in New York.' },

  // Upper Elementary (9-11)
  { id: 'harry-potter', title: "Harry Potter and the Sorcerer's Stone", author: 'J.K. Rowling', illustrator: 'Mary GrandPré', ageGroup: 'upper-elementary', genre: 'Fantasy', description: 'A boy discovers he is a wizard.' },
  { id: 'narnia-lion', title: 'The Lion, the Witch and the Wardrobe', author: 'C.S. Lewis', illustrator: 'Pauline Baynes', ageGroup: 'upper-elementary', genre: 'Fantasy', description: 'Four children enter a magical land through a wardrobe.' },
  ...
  { id: 'phantom-tollbooth', title: 'The Phantom Tollbooth', author: 'Norton Juster', illustrator: 'Jules Feiffer', ageGroup: 'upper-elementary', genre: 'Fantasy', description: 'A bored boy journeys through the Lands Beyond.' },
