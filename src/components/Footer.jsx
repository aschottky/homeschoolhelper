      ...
      <div className="container">
        <div className="footer-grid">
          ...
          <div className="footer-links">
            <h4>Community</h4>
            <ul>
              <li><a href="#">Parent Forums</a></li>
              <li><a href="#">Local Co-ops</a></li>
              <li><a href="#">Events Calendar</a></li>
              <li><a href="#">Success Stories</a></li>
              <li><a href="#">Expert Q&A</a></li>
            </ul>
          </div>
          ...
          <div className="footer-links">
            <h4>Company</h4>
            <ul>
              <li><button onClick={onOpenAbout} className="footer-link-btn">About Us</button></li>
              <li><button onClick={onOpenAbout} className="footer-link-btn">Our Team</button></li>
