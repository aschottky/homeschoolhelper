...
const resources = [
  {
    ...
    count: '120+ Resources',
    items: ['Reading comprehension', 'Creative writing', 'Grammar & vocabulary'],
    color: 'terracotta'
  },
  {
    icon: Calculator,
    ...
    count: '95+ Resources',
    items: ['Problem solving', 'Mental math', 'Geometry & algebra'],
    color: 'forest'
  },
  {
    icon: FlaskConical,
    category: 'Science',
    count: '85+ Resources',
    items: ['Hands-on experiments', 'Nature studies', 'Earth & space'],
    color: 'sage'
  },
  {
    icon: Globe,
    ...
    count: '75+ Resources',
    items: ['World cultures', 'Timeline activities', 'Map skills'],
    color: 'terracotta'
  },
  {
    icon: Palette,
    ...
    count: '60+ Resources',
    items: ['Drawing tutorials', 'Craft projects', 'Art history'],
    color: 'forest'
  },
  {
    icon: Music,
    ...
    count: '45+ Resources',
    items: ['Instrument basics', 'Music theory', 'Dance & PE'],
    color: 'sage'
  }
]
